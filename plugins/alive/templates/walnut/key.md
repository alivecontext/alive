...
<!-- Wikilinks to other walnuts this one relates to.
     ...
     - [[nova-industries]] — parent company
-->

<!-- SUB-WALNUTS: If this walnut has children (folders that are full walnuts
     with their own key.md), list them here. Each child's key.md must have
     parent: [[this-walnut]] in its frontmatter.
